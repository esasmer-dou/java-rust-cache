...
[![Version](https://img.shields.io/badge/version-0.7.4-blue.svg)](https://github.com/esasmer-dou/java-rust-cache/releases/tag/v0.7.4)
[![REST line](https://img.shields.io/badge/rust--java--rest-4.5.0-green.svg)](https://github.com/esasmer-dou/rust-java-rest/releases/tag/v4.5.0)
...
`rust-java-rest:4.5.0` or newer, so the framework native bridge and cache library use the same
binary contract. The packaged provenance manifest records REST ABI `28`, Dubbo ABI `7`, Redis ABI
`6`, Glowroot ABI `1`, the full source revision, and platform SHA-256 hashes. Startup rejects a
...
mvn -q dependency:get "-Dartifact=com.reactor:java-rust-cache:0.7.4"
```
...
Release details: [java-rust-cache 0.7.4](docs/RELEASE_NOTES_v0.7.4.md).
