...
[![Version](https://img.shields.io/badge/version-0.7.2-blue.svg)](https://github.com/esasmer-dou/java-rust-cache/releases/tag/v0.7.2)
...
`rust-java-rest:4.4.0` or newer, so the framework native bridge and cache library use the same
...
Release details: [java-rust-cache 0.7.2](docs/RELEASE_NOTES_v0.7.2.md).
