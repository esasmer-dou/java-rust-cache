...
[![Version](https://img.shields.io/badge/version-0.7.3-blue.svg)](https://github.com/esasmer-dou/java-rust-cache/releases/tag/v0.7.3)
[![REST line](https://img.shields.io/badge/rust--java--rest-4.4.1-green.svg)](https://github.com/esasmer-dou/rust-java-rest/releases/tag/v4.4.1)
...
`rust-java-rest:4.4.1` or newer, so the framework native bridge and cache library use the same
...
mvn -q dependency:get "-Dartifact=com.reactor:java-rust-cache:0.7.3"
```
...
Release details: [java-rust-cache 0.7.3](docs/RELEASE_NOTES_v0.7.3.md).
