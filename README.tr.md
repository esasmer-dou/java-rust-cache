...
[![Sürüm](https://img.shields.io/badge/sürüm-0.7.4-blue.svg)](https://github.com/esasmer-dou/java-rust-cache/releases/tag/v0.7.4)
[![REST çizgisi](https://img.shields.io/badge/rust--java--rest-4.5.0-green.svg)](https://github.com/esasmer-dou/rust-java-rest/releases/tag/v4.5.0)
...
`rust-java-rest` de kullanıyorsa `rust-java-rest:4.5.0` veya daha yeni aynı çizgiyi kullanın. Böylece
framework native bridge ile cache library aynı binary sözleşmesini kullanır. Paketlenen provenance
manifesti REST ABI `28`, Dubbo ABI `7`, Redis ABI `6`, Glowroot ABI `1`, tam kaynak revision ve
...
Sürüm ayrıntıları: [java-rust-cache 0.7.4](docs/RELEASE_NOTES_v0.7.4.tr.md).
